...
async def main(manga_name: str, save_dir: str):
    ...
    print("item_example_href", item_example_href)
...
if __name__ == '__main__':
    ...
    asyncio.get_event_loop().run_until_complete(main("ge good ending", save_dir))